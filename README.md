...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/icy-water-6164)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/icy-water-6164
```

A live public deployment of this template is available at [https://icy-water-6164.templates.workers.dev](https://icy-water-6164.templates.workers.dev)
